...
<div class="portlet box grey-cascade">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-plus green"></i>新建角色
        </div>
        <div class="tools">
    ...
    <div class="table portlet-body portlet-body form">
    <!-- BEGIN FORM-->
    <form action="/umplatform/role/post"  class="horizontal-form">
        <div class="form-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-icon right">
                                <div class="input-icon right">
                                    <input type="text" id="roleName" name="roleName" class="form-control required" placeholder="角色名称" validate="{required: true}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="icon" name="icon" class="form-control required" placeholder="角色图标" validate="{required: true}">
                        </div>
                    </div>
                </div>
                <!--/span-->
                ...
                <div class="col-md-12 ">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="remark" name="remark" class="form-control required" placeholder="角色描述" validate="{required: true}">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 ">
                        <label class="control-label">权限列表</label>
                            <table id="resourceTreeTable" class="table table-striped table-bordered table-hover dataTable treetable col-md-12">
                                <thead>
                                <tr>
