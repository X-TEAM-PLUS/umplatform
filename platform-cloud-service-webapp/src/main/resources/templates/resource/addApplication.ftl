    ...
    <div class="tab-pane active" id="tab_0">
        <div class="portlet box grey-cascade">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="/umplatform/application/post" class="form-horizontal">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="url" id="url" class="form-control" placeholder="应用地址" validate="{minlength: 2,maxlength:100,required: true}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="logoutUrl" id="logoutUrl" class="form-control" placeholder="退出地址" validate="{minlength: 2,maxlength:100,required: true}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-group ">
                                    ...
                                    <input type="text" name="icon" id="icon" class="form-control" placeholder="应用图标" validate="{minlength: 2,maxlength:100,required: true}">
                                </div>
                            </div>
                        </div>
