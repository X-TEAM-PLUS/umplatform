...
var Layout = function () {
    ...
    var handleSidebarMenuActiveLink = function(mode, el) {
       ...
       // menu.find('li').addClass(" active open ")
    ...
    var handleSidebarMenu = function () {
        ...
        $('.page-sidebar').on('click', 'li > a', function (e) {
            ...
            if (keepExpand !== true) {
                ...
                parent.children('li.open').children('span').removeClass('selected');
                parent.children('li.open').removeClass('active');
            ...
            if (sub.is(":visible")) {
                ...
                the.parent().addClass(" active open ");
